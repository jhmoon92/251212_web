        ...
        child: Column(
          children: [
            TextFormField(
              ...
              keyboardType: (widget.textType == "number")
              ...
              decoration: InputDecoration(
                ...
                filled: true,
                fillColor: widget.readOnly ? commonGrey1 : commonWhite,
                                ...
                                : _emailConfirm
                                    ? widget.alreadyRegister!
                                        ? GestureDetector(
                                            ...
                                            child: SvgPicture.asset("assets/images/ic_32_circle_cancel.svg",
                                                height: 32, width: 32, fit: BoxFit.none),
                                          )
                                        : SvgPicture.asset("assets/images/ic_32_circle_check_checked.svg",
                                            height: 32, width: 32, fit: BoxFit.none)
                                    : widget.readOnly ? Container() :GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            widget.controller!.clear();
                                          });
                ...
                enabledBorder: const OutlineInputBorder(
                    borderSide: BorderSide(color: commonGrey4, width: 1.0), borderRadius: BorderRadius.all(Radius.circular(4.0))),
                focusedBorder: OutlineInputBorder(
                    borderSide: _showVerify
                        ...
                        child: Row(
                          ...
                          children: [
                            widget.controller!.text.length >= widget.minTextValidation
                                ...
                                : SvgPicture.asset("assets/images/ic_16_check.svg",
                    ...
                    child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: MediaQuery.of(context).size.width - 100,
                              child: Text(widget.validText == "" ? "error_char_limit_upto_30".tr() : widget.validText,
                                  style: captionCommon(commonGrey5)),
                            )
                          ],
                        )),
